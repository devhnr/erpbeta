            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('men-power.update', $menpower_data->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="surveyor_name" name="surveyor_name" type="text" class="form-control"
                                            placeholder="Enter Man Power Name" value="{{ $menpower_data->name }}" />
                                        <p class="form-error-text" id="surveyor_name_error" style="color: red; margin-top: 10px;"></p>
                                    </div>
                                    <div class="form-group">
                                        <input id="user_name" name="user_name" type="hidden" class="form-control" value="{{ $menpower_data->user_name}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="surveyor_mobile" name="surveyor_mobile" type="text" class="form-control"
                                            placeholder="Enter Man Power Mobile" value="{{ $menpower_data->mobile }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="email" name="email" type="text" class="form-control" value="{{ $menpower_data->email }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="surveyor_add" id="surveyor_add" cols="5" rows="5" class="form-control"
                                            placeholder="Enter Man Power Address">{{ $menpower_data->surveyor_add }}</textarea>
                                        </textarea>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3" style="padding: 10px;">
                                        @php
                                        $timeZoneIds = explode(',', $menpower_data->time_zone_id);
