...
@section('content')
    <style type="text/css">
        ...
        @php 
            if(Route::currentRouteName() === "revise.accepted-quotation"){
                $title = "Accepted Quotation";
                $routre = route('accepted-quotation.index');
                $updatefrom = "revise.accepted-quotation";
                $attfrom = "accepted-quotation";
            }elseif(Route::currentRouteName() === "revise.request"){
                $title = "quotation";
                $routre = route('quote.index');
                $updatefrom = "quotation";
                $attfrom = "quotation";
            }elseif(Route::currentRouteName() === "revise.job-order"){
                $title = "Job Order";
                $routre = route('job-order.index');
                $updatefrom = "job-order";
                $attfrom = "job-order";
            }elseif(Route::currentRouteName() === "revise.operation"){
                $title = "Operation";
                $routre = route('operation.index');
                $updatefrom = "operation";
                $attfrom = "operation";
            }elseif(Route::currentRouteName() === "revise.shipment"){
                $title = "Shipment";
                $routre = route('shipment.index');
                $updatefrom = "shipment";
                $attfrom = "shipment";
            }elseif(Route::currentRouteName() === "revise.billing-invoice"){
                $title = "Billing Invoice";
                $routre = route('billing-invoice.index');
                $updatefrom = "billing-invoice";
                $attfrom = "billing-invoice";
            }
            else{
                $title = "Costing";
                $routre = route('costing.index');
                $updatefrom = "costing";
                $attfrom = "costing";
            }
        @endphp
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ $routre }}">{{$title}}</a></li>
                                    ...
                                    <div id="costing_info_fields" class="hidden">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="add-remove text-end">
                                                                    ...
                                                                    @if(Route::currentRouteName() === "revise.request")
                                                                        ...
                                                                        @endif
                                                                    @else
                                                                        <i class="fas fa-minus-circle" onclick="singledelete('{{ route('costing.remove', ['enquiry_id' => $costing->enquiry_id, 'id' => $costing->id, 'updatefrom' => $attfrom]) }}')"></i>
                                                                        @if($i === 0)
                                                                        <i class="fas fa-plus-circle add-row"></i>
                                                                        @endif
                                                                    @endif
                                        ...
                                        <div class="col-md-4 mt-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" name="quote_vol"  id="quote_vol" value="{{ isset($followup_data->quote_vol) ? $followup_data->quote_vol : "" }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="prepared_by" name="prepared_by" type="text" class="form-control" value="{{Auth::user()->name}}" readonly/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="name">Est Time to Complete</label>
                                        <input id="est_time_to_complete" name="est_time_to_complete" type="text" class="form-control" value="{{ isset($followup_data->est_time_to_complete) ?  $followup_data->est_time_to_complete : "" }}" />
                                    </div>
                                </div>
                                {{-- <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="name">Estimated volume</label>
                                        <input id="estimated_volume" name="estimated_volume" type="text" class="form-control" value="{{ isset($followup_data->estimated_volume) ?  $followup_data->estimated_volume : "" }}" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="name">Transport Mode</label>
                                        <input id="transport_mode" name="transport_mode" type="text" class="form-control" value="{{ isset($followup_data->transport_mode) ?  $followup_data->transport_mode : "" }}" />
                                    </div>
                                </div> --}}
                            </div>
...
<input type="hidden" id="vat_enabled" value="{{ $quotation_data->vat_charge ?? 0 }}">
...
@section('footer_js')
    ...
    function updateGlobalSum(margin,margin_amount,changedBy = 'margin') {
        ...
        let vatCharge = parseInt($('#vat_enabled').val()) || 0; // 1 = apply 5% VAT, 0 = no VAT
        let vatAmount = 0;

        if (vatCharge === 1) {
            vatAmount = (withMargin * 0.05).toFixed(2);
        }

        let totalWithVat = (parseFloat(withMargin) + parseFloat(vatAmount)).toFixed(2);
        ...
        $('#global-total-hidden').val(globalTotal.toFixed(2));
         ...
         $('#newgrandtotal').val(totalWithVat);
