    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('41', $add_perm) || in_array('41', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('41', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('godowns.create') }}">
                            <i class="fas fa-plus"></i> Add Godown
                        </a>
                        @endif
                        @if (in_array('41', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_godowns();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('godowns.destroy') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('41', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('godowns.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_godowns" role="dialog">
 ...
 <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- /set orderModal -->
    <script>
        function delete_godowns() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_godowns').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
