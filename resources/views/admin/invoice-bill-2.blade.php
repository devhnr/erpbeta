...
<body>
    ...
    <table style="width: 100%; border-collapse: collapse;" class="customtable">
        ...
        <tr>
            ...
            <td style="border: 1px solid #000;text-align: left;vertical-align: top;font-family:sans-serif;">Dated: {{date('d-m-Y')}}</td>
        </tr>
        <tr>
    ...
    <table style="border-collapse: collapse; width: 100%;font-family:sans-serif;" class="customtable">
        <tr>
            ...
            <th style="border: 1px solid #000;padding: 5px 220px 5px 5px;text-align: left;vertical-align: top;">Description of Services</th>
        ...
        @if(isset($costing_attribute) && !empty($costing_attribute) && count($costing_attribute) > 0)
            ...
            <tr>
                ...
                <td style="border: 1px solid #000;padding: 5px 220px 5px 5px;text-align: left;vertical-align: top;">{{ $costing->code }}</td>
        ...
        @else 
            <tr>
                ...
                <td style="border: 1px solid #000;padding: 5px 220px 5px 5px;text-align: left;vertical-align: top;">{{ $followup->description }}</td>
                ...
                <td style="border: 1px solid #000;padding: 5px 8px;text-align: left;vertical-align: top;">{{ number_format($followup->grand_total_with_vat,2) }}</td>
                @if(isset($invoice_data) && $invoice_data->vat_charge == 1)
                    <td style="border: 1px solid #000;padding: 5px 8px;text-align: left;vertical-align: top;">5%</td>
                @endif
            </tr>
        ...
        @php
            if($totalQty == 0){
                ...
                $total_amount = round($followup->grand_total_with_vat);
            }
        ...
        <tr>
            ...
            <td style="border: 1px solid #000;padding: 5px 8px;text-align: left;vertical-align: top;" colspan="3" class="bold text-left">AED {{ number_format($followup->grand_total_with_vat,2) }}</td>
            @if(isset($invoice_data) && $invoice_data->vat_charge == 1)
                {{-- <td></td> --}}
            @endif
        </tr>
