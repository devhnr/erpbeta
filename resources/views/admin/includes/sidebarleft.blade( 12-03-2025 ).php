        ...
        <ul>
            ...
            @if (in_array('17', $permission1)||
             ...
             <li class="submenu">
                ...
                request()->segment(1) == 'approved-agents' || request()->segment(1) == 'reference' ? 'active' : '' }}">
                    <i data-feather="pie-chart"></i> <span>Organization Master</span> <span class="menu-arrow"></span></a>
                <ul>
                 @if (in_array('17', $permission1))
            ...
            @if (in_array('5', $permission1)||
             ...
             <li class="submenu">
                ...
                request()->segment(1) == 'service' || request()->segment(1) == 'services-required' || request()->segment(1) == 'description-of-goods' || request()->segment(1) == 'surveyor_type'|| request()->segment(1) == 'storage_type' || request()->segment(1) == 'frequencies' || request()->segment(1) == 'durations' || request()->segment(1) == 'storage_mode' || request()->segment(1) == 'enquiry_mode' || request()->segment(1) == 'source-of-contact' ||  request()->segment(1) == 'product-type' ? 'active' : '' }}">
                    <i data-feather="pie-chart"></i> <span>Enquiry Master</span> <span class="menu-arrow"></span></a>
                <ul>
                    {{-- @if (in_array('5', $permission1))
            ...
            <li class="submenu">
                <a href="#"
                    ...
                    <i data-feather="pie-chart"></i> <span>Costing Master</span> <span class="menu-arrow"></span></a>
                <ul>
                @if (in_array('27', $permission1))
                    <li>
            ...
            @endif
             ...
             @if(in_array('14', $permission1) ||
                ...
                <li class="submenu">
                    <a href="#"
                        class="{{ request()->segment(1) == 'agent' || request()->segment(1) == 'followup' || request()->segment(2) == 'survey' || request()->segment(2) == 'enquiry-detail' || request()->segment(2) == 'survey-detail' || request()->segment(2) == 'costing' || request()->segment(2) == 'costing-add' || request()->segment(2) == 'costing-detail' || request()->segment(2) == 'quotation' || request()->segment(2) == 'quotation-detail' || request()->segment(2) == 'quotation-add' || request()->segment(2) == 'customer-mail' || request()->segment(2) == 'revise-request' ? 'active' : '' }}">
            ...
            @endif
            @if (in_array('35', $permission1) || in_array('36', $permission1) || in_array('37', $permission1))
            <li class="submenu">
                <a href="#" class="{{ request()->segment(2) == 'accepted-quotation' || request()->segment(1) == 'job-order' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' ? 'active' : '' }}">
                ...
                <ul>
                    ...
                    @if (in_array('37', $permission1))
                        <li class="{{ request()->segment(1) == 'operation' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' ? 'active' : '' }}">
                            <a href="{{ route('operation.index') }}"
                                class="{{ request()->segment(1) == 'operation' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' ? 'active' : '' }}">
                                Operation
                            </a>
                        </li>
                    @endif
            ...
            @endif
            @if (in_array('1', $permission1) || in_array('2', $permission1) || in_array('13', $permission1) || in_array('38', $permission1) || in_array('39', $permission1))
                <li class="submenu">
                    <a href="#"
