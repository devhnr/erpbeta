<div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
            ...
            <li class="submenu">
                <a href="#" class="{{ request()->segment(2) == 'accepted-quotation' || request()->segment(1) == 'job-order' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' ? 'active' : '' }}">
                ...
                <ul>
                    ...
                    @if (in_array('37', $permission1))
                        <li class="{{ request()->segment(1) == 'operation' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' ? 'active' : '' }}">
                            <a href="{{ route('operation.index') }}"
                                class="{{ request()->segment(1) == 'operation' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' ? 'active' : '' }}">
                                Operation
                            </a>
                        </li>
                    @endif
