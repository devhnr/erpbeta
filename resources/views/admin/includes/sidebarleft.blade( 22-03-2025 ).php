<div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
            ...
            <li class="submenu">
                <a href="#" class="{{ request()->segment(2) == 'accepted-quotation' || request()->segment(1) == 'job-order' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' || request()->segment(2) == 'add-label' || request()->segment(2) == 'add-documents' || request()->segment(2) == 'get-report' ? 'active' : '' }}">
