    ...
    <div id="sidebar-menu" class="sidebar-menu">
        ...
        <ul>
                ...
                <ul>
                    ...
                    @if (in_array('52', $permission1))
                        <li class="{{ request()->segment(2) == 'expense' ? 'active' : '' }}">
                            <a href="{{ route('expense.lists') }}"
                                class="{{ request()->segment(2) == 'expense' ? 'active' : '' }}">Expense</a>
                        </li>
                    @endif
                </ul>
            </li>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        @if (in_array('15', $permission1))
                            <li class="{{ request()->segment(1) == 'followup' || request()->segment(2) == 'followup' || request()->segment(1) == 'surveyor_form' || request()->segment(2) == 'enquiry-detail'  ? 'active' : '' }}">
            ...
            @if (in_array('35', $permission1) || 
                 ...
                 in_array('44', $permission1))
            <li class="submenu">
                <a href="#" class="{{ request()->segment(2) == 'accepted-quotation' || request()->segment(1) == 'job-order' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' || request()->segment(2) == 'add-label' || request()->segment(2) == 'add-documents' || request()->segment(2) == 'get-report' || request()->segment(2) == 'shipment' || request()->segment(2) == 'shipment-detail' || request()->segment(2) == 'billing-invoice' || request()->segment(2) == 'job-order' || request()->segment(2) == 'operation' ? 'active' : '' }}">
                    <i data-feather="users"></i> <span> Customer Service</span> <span class="menu-arrow"></span>
                </a>
                <ul>
                    @if (in_array('35', $permission1))
                        <li class="{{ request()->segment(1) == 'accepted-quotation' || request()->segment(2) == 'accepted-quotation' ? 'active' : '' }}">
                    ...
                    @if (in_array('36', $permission1))
                        <li class="{{ request()->segment(1) == 'job-order' || request()->segment(2) == 'job-order' ? 'active' : '' }}">
                    ...
                    @if (in_array('37', $permission1))
                        <li class="{{ request()->segment(1) == 'operation' || request()->segment(2) == 'operation' || request()->segment(2) == 'add-man-power' || request()->segment(2) == 'add-vehicles' || request()->segment(2) == 'add-packing-material' || request()->segment(2) == 'operation-detail' || request()->segment(2) == 'add-label' || request()->segment(2) == 'add-documents' || request()->segment(2) == 'get-report' ? 'active' : '' }}">
            ...
            @if (in_array('46', $permission1) || 
                 in_array('45', $permission1) || 
                 in_array('47', $permission1) ||
                 in_array('48', $permission1))
                <li class="submenu">
                    <a href="#"
                        class="{{ request()->segment(2) == 'billing-invoice' || 
                                  request()->segment(2) == 'invoice-bill'    ||
                                  request()->segment(2) == 'company-account-details' ||
                                  request()->segment(2) == "invoice-detail" ||
                                  request()->segment(2) == 'closing' ||
                                  request()->segment(2) == 'closing-detail' ||
                                  request()->segment(2) == 'closing-add-amount' ||
                                  request()->segment(2) == 'receipt-voucher' ? 'active' : '' }}">

                        <i data-feather="clipboard"></i> <span> Billing</span> <span class="menu-arrow"></span>
                    </a>
                    <ul>
                        @if (in_array('46', $permission1))
                            <li class="{{ request()->segment(2) == 'billing-invoice' || 
                                          request()->segment(2) == 'invoice-bill' || 
                                          request()->segment(2) == 'invoice-report' ||
                                          request()->segment(2) == "invoice-detail" ? 'active' : '' }}">
                        ...
                        @if (in_array('47', $permission1))
                            <li class="{{ request()->segment(2) == 'closing' || request()->segment(2) == 'closing-detail' || request()->segment(2) == 'closing-add-amount' ? 'active' : '' }}">
                                <a href="{{ route('closing.index') }}"
                                    class="{{ request()->segment(2) == 'closing' || request()->segment(2) == 'closing-detail' || request()->segment(2) == 'closing-add-amount' ? 'active' : '' }}">
                                    {{-- <i class="fa fa-hand-o-up"></i>--}} Closed 
                                </a>
                            </li>
                        @endif

                        
                        @if (in_array('48', $permission1))
                            <li class="{{ request()->segment(2) == 'receipt-voucher' || request()->segment(2) == 'receipt-voucher-detail' ? 'active' : '' }}">
                                <a href="{{ route('receipt-voucher.index') }}"
                                    class="{{ request()->segment(2) == 'receipt-voucher' || request()->segment(2) == 'receipt-voucher-detail' ? 'active' : '' }}">
                                    {{-- <i class="fa fa-hand-o-up"></i>--}} Receipt Voucher 
                                </a>
                            </li>
                        @endif
            ...
            @if (in_array('49', $permission1) || in_array('50', $permission1))
                <li class="submenu">
                    <a href="#"
                        class="{{ request()->segment(2) == 'allenquiry' || request()->segment(2) == 'allenquiry-detail' || request()->segment(1) == 'allenquiry-filter' || request()->segment(2) == 'allenquiry-count-filter' ? 'active' : '' }}">

                        <i class="fas fa-comment-dots"></i> <span> All Enquiry</span> <span class="menu-arrow"></span>
                    </a>
                    <ul>
                        @if (in_array('49', $permission1))
                            <li class="{{ request()->segment(2) == 'allenquiry' || request()->segment(2) == 'allenquiry-detail' || request()->segment(1) == 'allenquiry-filter' ? 'active' : '' }}">

                                <a href="{{ route('allenquiry.lists') }}"
                                    class="{{ request()->segment(2) == 'allenquiry' || request()->segment(2) == 'allenquiry-detail' || request()->segment(1) == 'allenquiry-filter' ? 'active' : '' }}">
                                     All Enquiry 
                                </a>
                            </li>
                        @endif
                        ...
                        @if (in_array('50', $permission1))
                            <li class="{{ request()->segment(2) == 'allenquiry-count' || request()->segment(2) == 'allenquiry-count-filter' ? 'active' : '' }}">

                                <a href="{{ route('allenquiry.count') }}"
                                    class="{{ request()->segment(2) == 'allenquiry-count'  || request()->segment(2) == 'allenquiry-count-filter' ? 'active' : '' }}">
                                     Enquiry Count
                                </a>
                            </li>
                        @endif
            ...
            <li class="submenu">
                <a href="#"
                    class="{{ request()->segment(2) == 'salesreport'  ? 'active' : '' }}">

                    <i data-feather="file-text"></i> <span>Reports</span> <span class="menu-arrow"></span>
                </a>
                <ul>
                    @if (in_array('51', $permission1))
                        <li class="{{ request()->segment(2) == 'salesreport' ? 'active' : '' }}">

                            <a href="{{ route('salesreport.lists') }}"
                                class="{{ request()->segment(2) == 'salesreport' ? 'active' : '' }}">
                                 Sales Report
                            </a>
                        </li>
        ...
        @if (in_array('53', $permission1))
            <li class="submenu">
                <a href="#"
                    class="{{ request()->segment(2) == 'warehouse'  ? 'active' : '' }}">

                    <i class="fas fa-warehouse"></i> <span>Warehouse</span> <span class="menu-arrow"></span>
                </a>
                <ul>
                    @if (in_array('53', $permission1))
                        <li class="{{ request()->segment(2) == 'warehouse' ? 'active' : '' }}">

                            <a href="{{ route('warehouse.lists') }}"
                                class="{{ request()->segment(2) == 'warehouse' ? 'active' : '' }}">
                                 Warehouse
                            </a>
                        </li>
