                                    ...
                                    <tbody>
                                        @foreach ($followup_data as $followup)
                                            <tr>
                                               ...
                                               {{--  <td>
                                                    <select name="status_id" id="status_id_{{ $followup->id }}" class="form-control form-select select" onchange="shipmentStatusChange(this.value, '{{ $followup->id }}')">
...
@section('footer_js')
    ...
    <script>
        ...
        function shipmentStatusChange(element, enquiry_id) {
