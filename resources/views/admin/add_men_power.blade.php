...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Man Power</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('men-power.index') }}">Man Power</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="category_form" action="{{ route('men-power.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Man Power Name</label>
                                        <input id="surveyor_name" name="surveyor_name" type="text" class="form-control" placeholder="Enter Man Power Name" value="" />
                                        <p class="form-error-text" id="surveyor_name_error" style="color: red; margin-top: 10px;"></p>
                                    </div>
                                    <div class="form-group">
                                        <input id="user_name" name="user_name" type="hidden" class="form-control" placeholder="Enter Name" value="" />
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Man Power Mobile</label>
                                        <input id="surveyor_mobile" name="surveyor_mobile" type="text" class="form-control" placeholder="Enter Man Power Mobile" value="" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="conf_password" name="conf_password" type="password" class="form-control" placeholder="Enter Confirm Password" />
                                        <p class="form-error-text" id="confirm_password_error" style="color: red; margin-top: 10px;"></p>
                                    </div>
                                </div>

                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name">Man Power Address</label>
                                        <textarea name="surveyor_add" id="surveyor_add" cols="5" rows="5" class="form-control" placeholder="Enter Man Power Address"></textarea>
                            ...
                            <div class="text-end mt-4">
                                <a class="btn btn-primary" href="{{ route('men-power.index') }}">Cancel</a>
...
@section('footer_js')
    <script>
        ...
        function category_validation() {
            ...
            if (surveyor_name == '') {
                jQuery('#surveyor_name_error').html("Please Enter Man Power Name");
            ...
            $.ajax({
                ...
                success: function(msg) {
                    if (msg == 1) {
                        ...
                        if (surveyor_mobile == '') {
                            jQuery('#surveyor_mobile_error').html("Please Enter Man Power Mobile");
