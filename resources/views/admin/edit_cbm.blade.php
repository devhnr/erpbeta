        ...
        <div class="page-header">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="page-title">Edit CBM</h3>

                    <ul class="breadcrumb">

                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>

                        <li class="breadcrumb-item"><a href="{{ route('cbm.index') }}">CBM</a></li>

                        <li class="breadcrumb-item active">Edit CBM</li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="category_form" action="{{ route('cbm.update', $cbm->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name" type="input" class="form-control"
                                        ...
                                        placeholder="Enter Name" value="{{ $cbm->name }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="crew_req" name="crew_req" type="input" class="form-control"
                                        ...
                                        placeholder="Enter Crew Req For Job" value="{{ $cbm->crew_req }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="crew_day" name="crew_day" type="input" class="form-control"
                                        ...
                                        placeholder="Enter Crew Every Day" value="{{ $cbm->crew_day }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="truck" name="truck" type="input" class="form-control"
                                        ...
                                        placeholder="Enter Truck" value="{{ $cbm->truck }}" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="days" name="days" type="input" class="form-control"
                                        ...
                                        placeholder="Enter Days" value="{{ $cbm->days }}" />
