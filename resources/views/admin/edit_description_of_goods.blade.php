        ...
        <div class="page-header">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="page-title">Edit Description Of Goods</h3>

                    <ul class="breadcrumb">

                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>

                        <li class="breadcrumb-item"><a href="{{ route('description-of-goods.index') }}">Description Of Goods</a></li>

                        <li class="breadcrumb-item active">Edit Description Of Goods</li>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="service_form" action="{{ route('description-of-goods.update', $description_of_goods_data->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="description_of_goods_name" name="description_of_goods_name" type="text" class="form-control"
                                        placeholder="Enter Name" value="{{ $description_of_goods_data->name }}" />
