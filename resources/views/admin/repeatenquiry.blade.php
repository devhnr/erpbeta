...
input[type="checkbox"] {
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Repeat Enquiry</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('closing.index') }}">Repeat</a></li>
                        <li class="breadcrumb-item active">Repeat Enquiry</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="category_form" action="{{ route('closing.insertcopyenquiry', $followup->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="form-group col-lg-6">
                                    ...
                                    <input id="quote_no" name="quote_no" type="text" class="form-control"
                                        placeholder="Enter Packing Management Name" value=""
                                        readonly/>
                            ...
                            <div class="radio_show hidden" id="customer_form_container">
                                ...
                                <div class="form-group" >
                                    <input type="checkbox" id="origin_desti_move" name="origin_desti_move" onchange="originmovevisibility()" value="{{ $followup->origin_desti_move }}"  >
                                    ...
                                    &nbsp;
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" id="survey_req" name="survey_req" value="{{ $followup->survey_req }}" >
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="s_date" id="s_date" class="form-control origin_desti_val_blank" placeholder="Enter Survey Date" value="">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6"><b>Origin:/Pick up</b>
                                            <div class="form-group ">
                                                ...
                                                <input id="origin_add" name="origin_add" type="text" class="form-control origin_desti_val_blank"
                                                    placeholder="Enter Origin Address" value=""/>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                placeholder="Enter Origin ZIP/POST Code"  value="" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6"><b>Destination:/Delivery</b>
                                            <div class="form-group">
                                                ...
                                                placeholder="Enter Destination Address" value=""/>
                                            </div>
                                            <div class="form-group">
                                                <label for="name">Country:</label>
                                ...
                                <div class="form-group" >
                                    <input type="checkbox" id="storage_details" name="storage_details" onchange="storagedetailvisibility()" value="{{$followup->storage_details}}" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            <table id="allowance_table" class="table">
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    <td>Air</td>
                                                    <td><input type="text" id="air_input" name="air_input" class="form-control allowance_val_blank" value=""></td>
                                                    <td>
                                                  ...
                                                  <tr>
                                                    <td>Sea</td>
                                                    <td><input type="text" id="sea_input" name="sea_input" class="form-control allowance_val_blank" value=""></td>
                                                    <td>
                                                  ...
                                                  <tr>
                                                    <td>Rail</td>
                                                    <td><input type="text" id="rail_input" name="rail_input" class="form-control allowance_val_blank" value=""></td>
                                                    <td>
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="general_info_details" name="general_info_details" onchange="general_infovisibility()" value="{{$followup->general_info_details}}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="radio" name="payment_by" id="self_payment" value="Self"   class="gen_info_val_blank"> Self
                                            <input type="radio" name="payment_by" id="corporate_payment" value="Corporate"  class="gen_info_val_blank"> Corporate
                                            </div>
                                            <div class="form-group col-lg-4">
                                            ...
                                            <div class="form-group col-lg-4">
                                                ...
                                                <input type="text" style="display: none;" name="completed_date" placeholder="Enter Completed Date" class="form-control mt-2" id="completed_date" value="">
                                            </div>
                                            <div class="form-group col-lg-4">
                                                <label for="RMC">RMC:</label>
                                                <input type="text" name="rmc" id="rmc"
                                                 class="form-control gen_info_val_blank" placeholder="Enter RMC" value="">
                                            </div>
                                            <div class="form-group col-lg-4">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group ">
                                                   <textarea id="sales_notes" name="sales_notes" class="form-control" cols="50" rows="6" class="gen_info_val_blank"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
