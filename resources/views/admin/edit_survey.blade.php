    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    @php 
                    if(Route::currentRouteName() === "survey.edit"){
                        $title = "Survey";
                    }elseif(Route::currentRouteName() === "costing.edit"){
                        $title = "Costing";
                    }elseif(Route::currentRouteName() === "quotation.edit"){
                        $title = "Quotation";
                    }
                    elseif(Route::currentRouteName() === "accepted-quotation.edit"){
                        $title = "Accepted Quotation";
                    }
                    elseif(Route::currentRouteName() === "job-order.editinq"){
                        $title = "Job Order";
                    }
                    elseif(Route::currentRouteName() === "shipment.editinq"){
                        $title = "Shipment";
                    }
                    elseif(Route::currentRouteName() === "operation.editinq"){
                        $title = "Operation";
                    }
                    @endphp
                    <h3 class="page-title">Edit @php echo $title; @endphp</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        @if(Route::currentRouteName() === "survey.edit")
                        <li class="breadcrumb-item"><a href="{{ route('survey.index') }}">@php echo $title; @endphp</a></li>
                        @elseif(Route::currentRouteName() === "costing.edit")
                        <li class="breadcrumb-item"><a href="{{ route('costing.index') }}">@php echo $title; @endphp</a></li>
                        @elseif(Route::currentRouteName() === "quotation.edit")
                        <li class="breadcrumb-item"><a href="{{ route('quote.index') }}">@php echo $title; @endphp</a></li>
                        @elseif(Route::currentRouteName() === "accepted-quotation.edit")
                        <li class="breadcrumb-item"><a href="{{ route('accepted-quotation.index') }}">@php echo $title; @endphp</a></li>
                        @elseif(Route::currentRouteName() === "job-order.editinq")
                        <li class="breadcrumb-item"><a href="{{ route('job-order.index') }}">@php echo $title; @endphp</a></li>
                        @elseif(Route::currentRouteName() === "operation.editinq")
                        <li class="breadcrumb-item"><a href="{{ route('operation.index') }}">@php echo $title; @endphp</a></li>
                       
                        @elseif(Route::currentRouteName() === "shipment.editinq")
                        <li class="breadcrumb-item"><a href="{{ route('shipment.index') }}">@php echo $title; @endphp</a></li>
                        @endif
                        <li class="breadcrumb-item active">Edit @php echo $title; @endphp</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                         @php 
                           if(Route::currentRouteName() === "survey.edit"){
                                 $url = route('survey.update', $followup->id);
                           }elseif(Route::currentRouteName() === "costing.edit"){
                                 $url = route('costing.update', $followup->id);
                           }elseif(Route::currentRouteName() === "quotation.edit"){
                                 $url = route('quotation.update', $followup->id);
                           }elseif(Route::currentRouteName() === "accepted-quotation.edit"){
                                 $url = route('accepted-quotation.update', $followup->id);
                           }
                           elseif(Route::currentRouteName() === "job-order.editinq"){
                                 $url = route('job-order.updateinq', $followup->id);
                           }
                           elseif(Route::currentRouteName() === "operation.editinq"){
                                 $url = route('operation.updateinq', $followup->id);
                           }
                           elseif(Route::currentRouteName() === "shipment.editinq"){
                                 $url = route('shipment.updateinq', $followup->id);
                           }

                         @endphp
                        <form id="category_form" action="@php echo $url; @endphp" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input id="enquiry_date" name="enquiry_date" type="text" class="form-control"
                                        value="{{ $followup->enquiry_date }}" placeholder="Enter Survey Date" />
                                ...
                                @if(Route::currentRouteName() === "survey.edit")
                                    ...
                                    @elseif(Route::currentRouteName() === "costing.edit")
                                    <label for="name">Costing No</label>
                                    @elseif(Route::currentRouteName() === "quotation.edit")
                                ...
                                <div id="client_fields" class="hidden">
                                    <div class="row client-section-corporate">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="title_rank" id="title_rank" class="form-control form-select client_fields_val_blank select">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="agent_attr_id" id="agent_attr_id" class="form-control client_fields_val_blank form-select select">
                            ...
                            <div class="radio_show hidden" id="customer_form_container">
                                <div class="form-group" >
                                    ...
                                    <div id="individual_fields" class="hidden">
                                        <div class="row">
                                            <div class="form-group col-lg-6">
                                                <label for="name">Title/Rank:</label>
                                                <select name="customer_title_rank" id="customer_title_rank" class="form-control form-select cst_val_blank select">
                                                    <option value="">Select Title/Rank</option>
                                                    @foreach($title_rank as $title_rank_data)
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6"><b>Destination:/Delivery</b>
                                            ...
                                            <div class="form-group">
                                                <label for="name">Country:</label>
                                                <select name="desti_country" id="desti_country" class="form-select form-control origin_desti_val_blank select" />
                                                <option value="">Select Country</option>
                                                @foreach ($country_data as $country)
                                                <option value="{{ $country->id }}"
                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="form-group col-lg-4">
                                                ...
                                                <select name="status_id" id="status_id" class="form-control form-select gen_info_val_blank select">
                                                    ...
                                                    <option value="1" {{ $followup->status_id == '1' ? 'selected' : '' }}>Active</option>
                                                    <option value="2" {{ $followup->status_id == '2' ? 'selected' : '' }}>Completed</option>
                                                    <option value="3" {{ $followup->status_id == '3' ? 'selected' : '' }}>Followup</option>
                                                    <option value="4" {{ $followup->status_id == '4' ? 'selected' : '' }}>Lost</option>
                                                </select>
                                ...
                                @if(Route::currentRouteName() === "survey.edit")
                                    ...
                                    @elseif(Route::currentRouteName() === "costing.edit")
                                    <a class="btn btn-primary" href="{{ route('costing.index') }}"> Cancel</a>
                                    @elseif(Route::currentRouteName() === "quotation.edit")
