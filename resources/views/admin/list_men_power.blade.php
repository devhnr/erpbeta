            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Man Power</li>
                    </ul>
                </div>
                @if (in_array('39', $add_perm) || in_array('39', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('39', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('men-power.create') }}">
                            <i class="fas fa-plus"></i> Add Man Power
                        </a>
                        @endif
                        @if (in_array('39', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_surveyor();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('men-power.delete') }}" enctype="multipart/form-data">
                                ...
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th>Email</th>
                                            <th>Mobile No</th>
                                            @if (in_array('39', $edit_perm))
                                                <th class="text-right">Actions</th>
                                            @endif
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($men_power_data as $data)
                                            <tr>
                                                ...
                                                @if (in_array('39', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('men-power.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_surveyor" role="dialog">
 ...
 <div class="modal-dialog modal-dialog-centered">
    ...
    <!-- /set orderModal -->
    <script>
        function delete_surveyor() {
            // alert('test');
            var checked = $("#form input:checked").length > 0;
            if (!checked) {
                $('#select_one_record').modal('show');
            } else {
                $('#delete_surveyor').modal('show');
            }
        }
        function form_sub() {
            $('#form').submit();
