                                ...
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- @if (!is_null($survey_data) && isset($survey_data->survey_id) &&$survey_data->survey_id != '') --}}
                                            ...
                                            @endif --}}
                                            <td>
                                                <a class="btn btn-sm btn-primary" href="{{ route('enquiry.detail',$followup->id) }}">
                                            ...
                                            @if (in_array('15', $edit_perm))
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.copyfenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td> 
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.repeatfenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td> 
                                            @endif
