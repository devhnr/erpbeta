        ...
        <div class="page-header">
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <h3 class="page-title">Moving Cost</h3>
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Moving Cost</li>

                    </ul>

                </div>

                @if (in_array('27', $add_perm) || in_array('27', $delete_perm))
                <div class="col-auto">
                    @if (in_array('27', $add_perm))
                    <a class="btn btn-primary me-1" href="{{ route('movingcost.create') }}">
                        <i class="fas fa-plus"></i> Add Moving Cost
                    </a>
                    @endif
                    @if (in_array('27', $delete_perm))
            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_movingcost') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('27', $edit_perm))
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            ...
                                                            href="{{ route('movingcost.edit', $user_data[$i]->id) }}"><i
