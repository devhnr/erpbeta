    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('34', $add_perm) || in_array('34', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('34', $add_perm))
                        <a class="btn btn-primary me-1" href="{{  route('codes.create') }}">
                            <i class="fas fa-plus"></i> Add Code
                        </a>
                        @endif
                        @if (in_array('34', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('codes.delete') }}" enctype="multipart/form-data">
                                                ...
                                                @if (in_array('34', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{  route('codes.edit', $data->id) }}"><i
...
@section('footer_js')
 ...
 <div class="modal-dialog modal-dialog-centered">
     <div class="modal-content">
         <div class="modal-body">
             <div class="modal-text text-center">
                 <h3>Are you sure you want to Set order of Code</h3>
