                                        ...
                                        @foreach ($followup_data as $followup)
                                            <tr>
                                               ...
                                               {{--  <td>
                                                ...
                                                @endphp
                                                {{-- <td>
                                                    <select name="status_id" id="status_id_{{ $followup->id }}" class="form-control form-select select" onchange="closingStatusChange(this.value, '{{ $followup->id }}')">
                                                ...
                                                @php
                                                    if ($followup->grand_total != '') {
                                                        $grand_total = $followup->grand_total;
                                                    } else {
                                                        $grand_total = 0;
                                                    }
                                                @endphp
                                                ...
                                                @php
                                                $BalanceClosing = DB::table('closingamounts')
                                                                        ->where('enquiry_id', $followup->id)
                                                                        ->sum('total_amount_receive');

                                                $Balance = $grand_total - $BalanceClosing;
                                                @endphp
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                       href="{{ route('closing.closing_add_amount', $followup->id) }}">
                                                       <i class="fas fa-plus-circle"></i> <!-- Invoice file icon -->
                                                    </a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.detail', $followup->id) }}">
                                                        <i class="far fa-eye me-1"></i> View
                                                    </a>
                                                </td> 

                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.copyenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td> 
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.repeatenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td> 

                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.alldetail', $followup->id) }}">
                                                        <i class="far fa-eye me-1"></i> All Detail
                                                    </a>
                                                </td> 
