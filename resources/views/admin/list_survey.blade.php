                                ...
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            @endif
                                            @if(Route::currentRouteName() === "operation.index")
                                            <th>Crew<br/>Leader</th>
                                            <th>Man<br/>Power</th>
                                            <th>Vehicles</th>
                                            <th>Packing<br/>Material</th>
                                            <th>Labels</th>
                                            <th>Documents</th>
                                            <th>Reports</th>
                                            <th>Status</th>
                                            ...
                                            @if(Route::currentRouteName() === "survey.index")
                                                ...
                                                @endif
                                            @elseif(Route::currentRouteName() === "costing.index")
                                                @if (in_array('31', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif
                                            @elseif(Route::currentRouteName() === "quote.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif

                                            @elseif(Route::currentRouteName() === "accepted-quotation.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif
                                            @elseif(Route::currentRouteName() === "job-order.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif

                                                @elseif(Route::currentRouteName() === "operation.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif

                                                @elseif(Route::currentRouteName() === "shipment.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Enquiry</th>
                                                @endif
                                            ...
                                            @if(Route::currentRouteName() === "survey.index" || Route::currentRouteName() === "costing.index" || Route::currentRouteName() === "quote.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Copy Enquiry</th>
                                                @endif
                                            @endif
                                            @if(Route::currentRouteName() === "survey.index" || Route::currentRouteName() === "costing.index" || Route::currentRouteName() === "quote.index")
                                                @if (in_array('32', $edit_perm))
                                                    <th class="text-right">Repeat Enquiry</th>
                                                @endif
                                            @endif
                                    ...
                                    <tbody>
                                       ...
                                       {{--  @if (!is_null($survey_data) && isset($survey_data->survey_id) &&$survey_data->survey_id != '')
                                            ...
                                            <td>
                                                <a class="btn btn-primary"
                                                   href="{{ route('operation-lable.edit', $followup->id) }}">
                                                   <i class="fas fa-tags"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-primary"
                                                   href="{{ route('operation-documents.edit', $followup->id) }}">
                                            ...
                                            <td>
                                                <a class="btn btn-primary"
                                                   href="{{ route('get-reports', $followup->id) }}"
                                                   {{-- href="{{ route('client-care-report.download', $followup->id) }}" --}}
                                                >
                                                   {{-- <i class="fas fa-upload"></i> --}}
                                            ...
                                            @elseif(Route::currentRouteName() === "costing.index")
                                                @if (in_array('31', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                        href="{{ route('costing.edit', $followup->id) }}"><i
                                                        class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                @if (in_array('32', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                        href="{{ route('quotation.edit', $followup->id) }}"><i
                                                        class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                @if (in_array('32', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                        href="{{ route('accepted-quotation.edit', $followup->id) }}"><i
                                                        class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                @if (in_array('32', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                        href="{{ route('job-order.editinq', $followup->id) }}"><i
                                                        class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                @if (in_array('32', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                        href="{{ route('operation.editinq', $followup->id) }}"><i
                                                        class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                @endif
                                                ...
                                                @if(Route::currentRouteName() === "accepted-quotation.index")
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary"
                                                        href="{{ route('revise.accepted-quotation', $followup->id) }}">
                                                ...
                                                @elseif(Route::currentRouteName() === "job-order.index")
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary"
                                                        href="{{ route('revise.job-order', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                        </a>
                                                        <a href="javascript:void(0)" onclick="javascript:download_quotation('{{$followup->id}}')" class="btn btn-primary"><i class="fa fa-download"></i></a>
                                                ...
                                                @elseif(Route::currentRouteName() === "operation.index")
                                                    ...
                                                    <td>
                                                        <a class="btn btn-primary"
                                                        href="{{ route('revise.operation', $followup->id) }}">
                                                        <i class="far fa-edit"></i> 
                                                        </a>
                                                        <a href="javascript:void(0)" onclick="javascript:download_quotation('{{$followup->id}}')" class="btn btn-primary"><i class="fa fa-download"></i></a>
                                                    </td>
                                                ...
                                                @if(Route::currentRouteName() === "survey.index")
                                                    @if (in_array('32', $edit_perm))
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('closing.copysurveyenquiry', $followup->id) }}">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                    </td> 
                                                    @endif
                                                @elseif(Route::currentRouteName() === "costing.index")
                                                    @if (in_array('32', $edit_perm))
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('closing.copycostingenquiry', $followup->id) }}">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                    @endif
                                                @elseif(Route::currentRouteName() === "quote.index")
                                                    @if (in_array('32', $edit_perm))
                                                    <td>
                                                        <a class="btn btn-sm btn-primary" href="{{ route('closing.copyquoteenquiry', $followup->id) }}">
                                                            <i class="far fa-edit"></i>
                                                        </a>
                                                    </td>
                                                    @endif
                                                ...
                                                @if (in_array('32', $edit_perm))
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.repeatsurveyenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td> 
                                                @endif
                                            @elseif(Route::currentRouteName() === "costing.index")
                                                @if (in_array('32', $edit_perm))
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.repeatcostingenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td>
                                                @endif
                                            @elseif(Route::currentRouteName() === "quote.index")
                                                @if (in_array('32', $edit_perm))
                                                <td>
                                                    <a class="btn btn-sm btn-primary" href="{{ route('closing.repeatquoteenquiry', $followup->id) }}">
                                                        <i class="far fa-edit"></i>
                                                    </a>
                                                </td>
                                                @endif
