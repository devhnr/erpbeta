            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">CBM</li>

                    </ul>

                </div>

                @if (in_array('28', $add_perm) || in_array('28', $delete_perm))
                <div class="col-auto">
                    @if (in_array('28', $add_perm))
                    <a class="btn btn-primary me-1" href="{{ route('cbm.create') }}">
                        <i class="fas fa-plus"></i> Add CBM
                    </a>
                    @endif
                    @if (in_array('28', $delete_perm))
            ...
            <div class="col-sm-12">
                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" action="{{ route('delete_cbm') }}" enctype="multipart/form-data">
                                ...
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    ...
                                    <thead class="thead-light">
                                        ...
                                        <tr>
                                            ...
                                            <th>Select</th>
                                            <th>Name</th>
                                            <th>Crew Req For Job</th>
                                            <th>Crew Every Day</th>
                                            <th>Truck</th>
                                            <th>Days</th>
                                    ...
                                    <tbody>
                                        ...
                                        @for ($i = 0; $i < count($user_data); $i++)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $user_data[$i]->crew_req }}
                                                </td>
                                                <td>
                                                    {{ $user_data[$i]->crew_day }}
                                                </td>
                                                <td>
                                                    {{ $user_data[$i]->truck }}
                                                </td>
                                                ...
                                                @if (in_array('28', $edit_perm))
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <a class="btn btn-primary"
                                                            ...
                                                            href="{{ route('cbm.edit', $user_data[$i]->id) }}"><i
