    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('42', $add_perm) || in_array('42', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('42', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('materials.create') }}">
                            <i class="fas fa-plus"></i> Add Material
                        </a>
                        @endif
                        @if (in_array('42', $delete_perm))
                        <a class="btn btn-danger me-1" href="javascript:void('0');" onclick="delete_materials();">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('materials.destroy') }}" enctype="multipart/form-data">
                                ...
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    <thead class="thead-light">
                                        <tr>
                                            <th>Select</th>
                                            <th>Name</th>
                                            @if (in_array('42', $edit_perm))
                                                <th class="text-right">Actions</th>
                                            @endif
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($materials_data as $data)
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    {!! Helper::countryname($data->country) !!}
                                                </td> --}}
                                                <td>
                                                    {{ $data->name }}
                                                </td>
                                                @if (in_array('42', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('materials.edit', $data->id) }}"><i
...
@section('footer_js')
    ...
    <div class="modal custom-modal fade" id="delete_materials" role="dialog">
