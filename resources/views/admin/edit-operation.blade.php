    ...
    <div class="content container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('operation.index') }}">Supervisor</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="category_form" action="{{ route('operation.update', $followup->id) }}" method="POST"
                            ...
                            <div class="row">
                               ...
                               {{--  <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-lg-4">
                                        <label for="name">Supervisor Pack Date From:</label>
                                    ...
                                    <div id="surveyor_sections" class="">
                                        ...
                                        <div id="surveyor_section_{{ $data->id }}" class="row form-group" style="margin-top: 10px; margin-left: 3px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2" style="border: 1px solid; padding: 6px; border-right: none; align-items: center; display: flex;">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input surveyor-radio surveyor_radio_checked"
                                                               type="checkbox"
                                                               name="supervisor_time_zone_name[]"
                                                               id="supervisor_time_zone_name_{{ $data->id }}"
                                                               value="{{ $data->id }}"
                                                               data-surveyor-id="{{ $data->id }}"
                                                               @if($supervisor_assign_data->contains('supervisors_id', $data->id)) checked @endif
                                                        />
                                                        <label class="form-check-label" for="supervisor_time_zone_name_{{ $data->id }}">
                                                            {{ $data->name }}
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="row col-md-10" style="border: 1px solid; padding: 10px;">
                                                  ...
                                                  @php
                                                    ...
                                                    if ($date_wise_supervisor_data->contains('supervisors_id', $data->id) &&
                                                        in_array($time_zone_id, explode(',', $date_wise_supervisor_data->firstWhere('supervisors_id', $data->id)->time_zones))) {
                                                ...
                                                @endphp
                                                  <div class="form-check col-md-2 ajax_replace" style="margin-top: 5px;">
                                                    <input class="form-check-input time-zone-radio surveyor-{{ $data->id }} {{ $disabledCheckbox }}"
                                                                ...
                                                                value="{{ $time_zone_id }}"
                                                                @if($supervisor_assign_data->contains('supervisors_id', $data->id) && in_array($time_zone_id, explode(',', $supervisor_assign_data->firstWhere('supervisors_id', $data->id)->time_zones))) checked @endif
                                                                {{ $inputDisabled }}
                                                            />
...
@section('footer_js')
    <script>
        function category_validation() {
            ...
            if (customer_type == '') {
                jQuery('#customer_type_error').html("Please Select Supervisor Type");
    ...
    <script>
        $(document).ready(function () {
            $("#operation_pack_date").on("change", function () {
                ...
                $.ajax({
                    url: "{{ route('checkSupervisorDate') }}", // Define route in web.php
                    type: "POST",
                    data: {
                        date: selectedDate,
        ...
        function disableCheckBoxes(assignments) {
            assignments.forEach(assign => {
                let supervisorId = assign.supervisors_id;
                ...
                timeZones.forEach(timeZoneId => {
                    $(`#surveyor_time_zone_${supervisorId}_${timeZoneId}`)
                            .prop('disabled', true)
