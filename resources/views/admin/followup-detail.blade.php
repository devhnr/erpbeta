...
input[type="checkbox"] {
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">{{ $moduleName }} Detail</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                        <li class="breadcrumb-item">
                            @if(Route::currentRouteName() === "enquiry.detail")
                                <a href="{{ route('followup.index') }}">{{ $moduleName }}</a>
                            @elseif(Route::currentRouteName() === "survey.detail")
                                <a href="{{ route('survey.index') }}">{{ $moduleName }}</a>
                            @elseif(Route::currentRouteName() === "costing.detail")
                                <a href="{{ route('costing.index') }}">{{ $moduleName }}</a>
                            @elseif (Route::currentRouteName() === "quote.detail")
                                <a href="{{ route('quote.index') }}">{{ $moduleName }}</a>
                            @elseif (Route::currentRouteName() === "shipment.detail")
                                <a href="{{ route('shipment.index') }}">{{ $moduleName }}</a>
                            @endif
                        </li>
                        <li class="breadcrumb-item active">{{ $moduleName }} Detail</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <form id="category_form" action="{{ route('followup.update', $followup->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="customer_type" id="customer_type" class="form-control form-select" onchange="customerType(this.value);">
                                ...
                                <div id="client_fields" class="hidden">
                                    <div class="row client-section-corporate">
                                        ...
                                        <div class="form-group col-lg-6">
                                            ...
                                            <select name="agent_attr_id" id="agent_attr_id" class="form-control client_fields_val_blank">
                            ...
                            <div class="radio_show hidden" id="customer_form_container">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div id="origin_desti_move_fields" class="hidden">
                                        <div class="row">
                                            ...
                                            <select name="move_type" id="move_type" class="form-control form-select select" onchange="move_data(this.value);" disabled>
                                    ...
                                    <div class="form-group" id="move_dat_hide" style="display: none">
                                        ...
                                        <input id="move_date" name="move_date" type="text" class="form-control"
                                            value="{{$followup->move_date}}" placeholder="Enter Move Date" readonly />
                                    ...
                                    <div class="form-group" id="move_val_hide" style="display: none">
                                        ...
                                        <input id="move_value" name="move_value" type="text" class="form-control"
                                            value="{{$followup->move_value}}" placeholder="Enter Move Value"  readonly/>
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row">
                                            ...
                                            @if(Route::currentRouteName() !== "survey.detail")
                                            <div class="form-group col-lg-4">
                                ...
                                <div class="text-end mt-4">
                                    @php
                                        $routes = [
                                            'enquiry.detail' => 'followup.index',
                                            'survey.detail' => 'survey.index',
                                            'costing.detail' => 'costing.index',
                                            'operation.detail' => 'operation.index',
                                            'shipment.detail' => 'shipment.index',
                                            'invoice.detail' => 'billing-invoice.index',
                                            'closing.detail' => 'closing.index',
                                        ];

                                        $routeName = Route::currentRouteName();
                                        $backRoute = $routes[$routeName] ?? 'quote.index';
                                    @endphp
                                    <a class="btn btn-primary" href="{{ route($backRoute) }}">Back</a>
                                </div>
                        </form>
                    </div>
                </div>
