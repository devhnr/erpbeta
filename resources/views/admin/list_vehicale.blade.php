    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                ...
                @if (in_array('40', $add_perm) || in_array('40', $delete_perm))
                    <div class="col-auto">
                        @if (in_array('40', $add_perm))
                        <a class="btn btn-primary me-1" href="{{ route('vehicles.create') }}">
                            <i class="fas fa-plus"></i> Add Vehicle
                        </a>
                        @endif
                        @if (in_array('40', $delete_perm))
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card card-table">
                    <div class="card-body">
                        <form id="form" action="{{ route('vehicles.destroy') }}" enctype="multipart/form-data">
                            ...
                            <div class="table-responsive">
                                <table class="table table-center table-hover datatable" id="header_lock">
                                    ...
                                    <tbody>
                                        @foreach ($vehicales_data as $data)
                                            <tr>
                                                ...
                                                @if (in_array('40', $edit_perm))
                                                    <td class="text-right">
                                                        <a class="btn btn-primary"
                                                            href="{{ route('vehicles.edit', $data->id) }}"><i
