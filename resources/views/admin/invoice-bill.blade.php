    ...
    <table style="border-collapse: collapse; width: 100%;font-family:sans-serif;" class="customtable">
        ...
        @if(isset($costing_attribute) && !empty($costing_attribute) && count($costing_attribute) > 0)
            ...
            <tr>
                ...
                <td style="border: 1px solid #000;padding: 5px 220px 5px 5px;text-align: left;vertical-align: top;">{{ $costing->description }}</td>
                {{-- <td style="padding: 5px 8px;text-align: left;vertical-align: top;"></td>
                <td style="padding: 5px 8px;text-align: left;vertical-align: top;"></td>
                <td style="padding: 5px 8px;text-align: left;vertical-align: top;"></td> --}}
        ...
        @else 
            <tr>
                ...
                <td style="border: 1px solid #000;padding: 5px 30px;text-align: left;vertical-align: top;">{{ $followup->description }}</td>
