...
Route::middleware('auth')->group(function () {
    ...
    /* Billing Invoice */
    Route::get('/admin/billing-invoice', [BillingInvoiceController::class, 'index'])->name('billing-invoice.index');
    Route::get('admin/invoice-bill/{enquiry_id}',[BillingInvoiceController::class,'invoice_bill'])->name('invoice.bill');
    Route::patch('/invoice-bill-update/{id}', [BillingInvoiceController::class, 'invoice_bill_update'])->name('invoice-bill.update');
    Route::get('admin/invoice-report/{id}', [BillingInvoiceController::class, 'invoice_generate'])->name('invoice.generate');
    Route::post('invoice-format-type', [BillingInvoiceController::class, 'invoice_format_type'])->name('invoice-format-type');
    Route::get('invoie-bill-download', [BillingInvoiceController::class, 'invoice_bill_download'])->name('invoie-bill.download');
