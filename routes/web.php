...
use App\Http\Controllers\admin\CompanyAccountDetailController;
use App\Http\Controllers\admin\BillingInvoiceController;
use App\Http\Controllers\admin\ClosingController;
use App\Http\Controllers\admin\ReceiptVoucherController;
use App\Http\Controllers\admin\Allenquirycontroller;
...
//Route::post('/testmail', '\App\Http\Controllers\admin\HomeController');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('admin/costing/edit/{id}/', [SurveyController::class, 'edit'])->name('costing.edit');
    Route::put('admin/costing/{id}', [SurveyController::class, 'update'])->name('costing.update');
    ...
    Route::get('costing-remove/{enquiry_id}/{id}/{updatefrom}', [SurveyController::class, 'costing_remove'])->name('costing.remove');
    ...
    Route::get('admin/quotation/edit/{id}/', [QouteController::class, 'edit'])->name('quotation.edit');
    Route::put('admin/quotation/{id}', [QouteController::class, 'update'])->name('quotation.update');
    ...
    Route::get('admin/accepted-quotation/edit/{id}/', [SurveyController::class, 'edit'])->name('accepted-quotation.edit');
    Route::put('admin/accepted-quotation/{id}', [AcceptedQuotationController::class, 'update'])->name('accepted-quotation.update');

    Route::get('admin/accepted-quotation/{id}', [QouteController::class, 'revise_request'])->name('revise.accepted-quotation');
    ...
    Route::get('admin/job-order/edit/{id}/', [SurveyController::class, 'edit'])->name('job-order.editinq');
    Route::put('admin/job-order/{id}', [JobOrderController::class, 'updateinquiry'])->name('job-order.updateinq');
    Route::get('admin/job-order/{id}', [QouteController::class, 'revise_request'])->name('revise.job-order');
    ...
    Route::get('admin/operation/editinq/{id}/', [SurveyController::class, 'edit'])->name('operation.editinq');
    Route::put('admin/operation/{id}', [OperationController::class, 'updateinquiry'])->name('operation.updateinq');

    Route::get('admin/operation/{id}', [QouteController::class, 'revise_request'])->name('revise.operation');
    ...
    Route::patch('/operation-label-update/{id}', [OperationController::class, 'update_label'])->name('operation-label.update');
    ...
    Route::post('operation-status-update', [OperationController::class, 'operation_status_change'])->name('operation-status.update');


    /* Shipment Module */
    Route::resource('admin/shipment', '\App\Http\Controllers\admin\ShipmentController');
    Route::get('admin/shipment-detail/{quote_id}',[FollowupController::class,'enquiry_detail'])->name('shipment.detail');
    Route::post('shipment-status-change', [ShipmentController::class, 'shipment_status_update'])->name('shipment-status-change');
    Route::get('admin/shipment/editinq/{id}/', [SurveyController::class, 'edit'])->name('shipment.editinq');
    Route::put('admin/shipment/updateinq/{id}', [ShipmentController::class, 'updateinquiry'])->name('shipment.updateinq');
    Route::get('admin/shipment/revise_request/{id}', [QouteController::class, 'revise_request'])->name('revise.shipment');


    /* CompanyAccountDetailController */
    Route::get('/admin/company-account-details/{id}/edit', [CompanyAccountDetailController::class, 'edit'])->name('companyAccountDetails.edit');
    Route::put('/company-account-details/{id}', [CompanyAccountDetailController::class, 'update'])->name('account-details.update');

    /* Billing Invoice */
    Route::controller(BillingInvoiceController::class)->group(function () {

        Route::get('/admin/billing-invoice', 'index')->name('billing-invoice.index');
        Route::get('/admin/invoice-bill/{enquiry_id}', 'invoice_bill')->name('invoice.bill');
        Route::patch('/invoice-bill-update/{id}', 'invoice_bill_update')->name('invoice-bill.update');
        Route::get('/admin/invoice-report/{id}', 'invoice_generate')->name('invoice.generate');
        Route::post('/invoice-format-type', 'invoice_format_type')->name('invoice-format-type');
        Route::get('/invoice-bill-download', 'invoice_bill_download')->name('invoice-bill.download');
        Route::post('/invoice-status-change', 'invoice_status_update')->name('invoice-status-update');
        Route::post('admin/expense-replace','expense_replace')->name('invoice.expense-replace');
        Route::post('admin/expense-inquiry-form', 'expense_inquiry_form')->name('invoice.expense-inquiry-form');

        Route::get('admin/billing-invoice/revise_request/{id}', [QouteController::class, 'revise_request'])->name('revise.billing-invoice');

    });
    Route::get('admin/invoice-detail/{quote_id}',[FollowupController::class,'enquiry_detail'])->name('invoice.detail');

    /* Closing Module */
    Route::controller(ClosingController::class)->group(function () {

        Route::get('/admin/closing', 'index')->name('closing.index');
        Route::post('/closing-status-change', 'closing_status_update')->name('closing-status-change');
        Route::get('/admin/closing-add-amount/{quote_id}', 'closing_add_amount')->name('closing.closing_add_amount');
        Route::post('/admin/add_amount', 'add_amount')->name('closing.add_amount');

        Route::get('/admin/closing/copyenquiry/{id}', 'copyenquiry')->name('closing.copyenquiry');
        Route::post('/admin/closing/insertcopyenquiry/{id}', 'insertcopyenquiry')->name('closing.insertcopyenquiry');
        Route::get('/admin/closing/repeatenquiry/{id}', 'repeatenquiry')->name('closing.repeatenquiry');

        Route::get('/admin/followup/copyfenquiry/{id}', 'copyenquiry')->name('closing.copyfenquiry');
        Route::get('/admin/survey/copysurveyenquiry/{id}', 'copyenquiry')->name('closing.copysurveyenquiry');
        Route::get('/admin/costing/copycostingenquiry/{id}', 'copyenquiry')->name('closing.copycostingenquiry');
        Route::get('/admin/quotation/copyquoteenquiry/{id}', 'copyenquiry')->name('closing.copyquoteenquiry');

        Route::get('/admin/survey/repeatsurveyenquiry/{id}', 'repeatenquiry')->name('closing.repeatsurveyenquiry');
        Route::get('/admin/costing/repeatcostingenquiry/{id}', 'repeatenquiry')->name('closing.repeatcostingenquiry');
        Route::get('/admin/quotation/repeatquoteenquiry/{id}', 'repeatenquiry')->name('closing.repeatquoteenquiry');
        Route::get('/admin/followup/repeatfenquiry/{id}', 'repeatenquiry')->name('closing.repeatfenquiry');


        Route::get('admin/closing/alldetail/{quote_id}','alldetail')->name('closing.alldetail');

    });
    Route::get('admin/closing-detail/{quote_id}',[FollowupController::class,'enquiry_detail'])->name('closing.detail');


    /*All enquiry  */
    Route::controller(Allenquirycontroller::class)->group(function () {

        Route::get('/admin/allenquiry', 'index')->name('allenquiry.lists');
        Route::match (['get','post'],'/allenquiry-filter','index')->name('allenquiry.allenquiry-filter');
        Route::get('/admin/allenquiry-count', 'count')->name('allenquiry.count');
        Route::match (['get','post'],'/admin/allenquiry-count-filter','count')->name('allenquiry.allenquiry-count-filter');

    });

    Route::get('admin/allenquiry-detail/{quote_id}',[FollowupController::class,'enquiry_detail'])->name('allenquiry.detail');


    /* Receipt Voucher */
    Route::controller(ReceiptVoucherController::class)->group(function () {

        Route::get('/admin/receipt-voucher', 'index')->name('receipt-voucher.index');
        Route::get('/admin/receipt-voucher-add/{id}', 'add_receipt_voucher')->name('receipt-voucher.add');
        
    });
    Route::get('admin/receipt-voucher-detail/{quote_id}',[FollowupController::class,'enquiry_detail'])->name('receipt-voucher.detail');

   /*  Route::get('/admin/closing', [ClosingController::class, 'index'])->name('closing.index');
    Route::post('closing-status-change', [ClosingController::class, 'closing_status_update'])->name('closing-status-change'); */
    ...
    Route::controller(Salesreportcontroller::class)->group(function () {
        ...
        Route::get('/admin/salesreport', 'index')->name('salesreport.lists');
        Route::match (['get','post'],'/admin/salesreport/filter','index')->name('salesreport.filter');
    ...
    Route::controller(Expensecontroller::class)->group(function () {
        ...
        Route::get('/admin/expense', 'index')->name('expense.lists');
        Route::get('/admin/expense/create', 'create')->name('expense.create');
        Route::post('/admin/expense/store', 'store')->name('expense.store');
        Route::get('/admin/expense/{id}/edit', 'edit')->name('expense.edit');
        Route::put('/admin/expense/{id}', 'update')->name('expense.update');
        Route::get('/admin/expense/delete', 'destroy')->name('expense.delete');

    });

    /* Warehouse module */
    Route::controller(Warehousecontroller::class)->prefix('admin')->group(function () {
        Route::get('/warehouse', 'index')->name('warehouse.lists');
        ...
        Route::get('/warehouse/delete', 'destroy')->name('warehouse.delete');
        Route::post('/warehouse/delete-document/{id}', 'deleteDocument')->name('warehouse.document.delete');
        Route::post('/warehouse/delete-partition/{id}', 'deletepartition')->name('warehouse.partition.delete');
