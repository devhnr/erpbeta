...
class OperationController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $data['assigned_dates']     = Supervisor::where('enquiry_id', $id)->pluck('assigned_date')->toArray();
        $data['supervisor_assign_data'] = Supervisor::where('enquiry_id', $id)->get();
        // echo "<pre>";print_r($data['supervisor_data']);echo"</pre>";exit;
    ...
    public function update(Request $request, $id)
    {
        ...
        echo "<pre>";print_r($supervisorTimeZoneNames);echo"</pre>";
        ...
        foreach ($supervisorTimeZoneNames as $supervisorId) {
            ...
            $checkSupervisorIdExists = Supervisor::where('enquiry_id',$id)->first();
