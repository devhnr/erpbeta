...
class SupervisorController extends Controller
{
    ...
    {
        $data['supervisor_data']= DB::table('users')->where('role_id',14)->orderBy('id','desc')->get();
        return view('admin.list_supervisor',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor.index')->with('success','Supervisor has been Added Successfully');
    }
    ...
    {
        $data['supervisor'] = DB::table('users')->where('id' , '=' , $id)->first();
       ...
       return view('admin.edit_supervisor',$data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('supervisor.index')->with('success', 'Supervisor has been Updated Successfully');
    }
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect()->route('supervisor.index')->with('success','Supervisor has been Deleted Successfully');
    }
}
