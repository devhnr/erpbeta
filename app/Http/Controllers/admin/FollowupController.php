...
class FollowupController extends Controller
{
    ...
    {
        //$user = Auth::user();
        //echo"<pre>";print_r($user->role_id);echo"</pre>";exit;
   ...
   /*  $data['service_req_val']      = $request->service_req_val;*/
    ...
    //    echo "<pre>";print_r($request->all());echo "</pre>";exit;
        ...
        $followup->contact_perosn_email      = $request->contact_perosn_email;
        $followup->contact_perosn_mobile      = $request->contact_perosn_mobile;
...
// dd($sql);exit;
    ...
    public function survey_information(Request $request){
        ...
        //    if ($original_survey_type != $data['survey_type'] || $original_surveyor != $data['surveyor_name'] || $original_transport_mode != $data['transport_mode']) {
           if ($original_survey_type != '') {

            //DB::table('survey_assign')->where('enquiry_id',$request->inquiry_id_hidden)->delete();
            //echo"hereddd";exit;
                ...
                $surveyUpdate['surveyor_time_zone'] = $data['surveyor_time_zone'] ?? "";
