...
class QouteController extends Controller
{
    ...
    /* public function quoteEmailFormat1(){
        $mailFormat1 =  '<!DOCTYPE html>
                                    <html lang="en">
                                    <head>
                                        <meta charset="UTF-8">
                                        <meta name="viewport" content="width=device-width, initial-scale=1.0">
                                        <title>UAE Quotation</title>
                                    </head>
                                    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f9;">
                                        <div style="width: 80%; margin: 20px auto; border: 1px solid #ddd; background-color: #fff; padding: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                                            <!-- Header Section -->
                                            <!-- Quotation Details -->
                                            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">Mr. NIKUL</td>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; background-color: #0056b3; color: #fff;">Quotation</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">QUOTE-2025-000023</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; background-color: #0056b3; color: #fff;">Date</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">20 January 2025</td>
                                                    ...
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">QUOTE-2025-000045</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; background-color: #0056b3; color: #fff;">Mobile</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">+971 - 45464546</td>
                                            ...
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">Dear Sir/Madam,</p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                QuickMove Technologies Supports<br>
                                                &bull; SEA FREIGHT<br>
                                                &bull; AIR FREIGHT<br>
                                                &bull; LAND FREIGHT
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">Kindly go through the Quotation prepared for SEA EXPORT Services from INDIA to UNITED ARAB EMIRATES to transport the COMMERCIAL GOODS through SEA is prepared based on the details shared from Shipper regarding the Services we provide and the prices.</p>
                                            <!-- Quotation Summary -->
                                            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">MOVE - SEA - SHARJAH TO HYDERABAD</td>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">4,200.00</td>
                                                </tr>
                                            </table>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;"><strong style="color: #000;">Net Total (AED)</strong> Four Thousand Two Hundred Only</p>
                                            ...
                                            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">Door To Door Export</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; color: #000;">Commodity</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">Household Goods</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; color: #000;">Transport</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">Sea</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; color: #000;">Origin Address</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">ADD, SHARJAH, UNITED ARAB EMIRATES</td>
                                                </tr>
                                                <tr>
                                                    <th style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px; color: #000;">Destination Address</th>
                                                    <td style="border: 1px solid #ddd; padding: 10px; text-align: left; font-size: 14px;">ADD, HYDERABAD, INDIA</td>
                                                </tr>
                                            </table>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">This proposal is based on the above details. Should there be an increase or decrease in weight or volume of your goods after packing, our rates will be revised after taking into account the fixed and variable costs.</p>
                                            <!-- Footer Section -->
                                            <h5 style="font-weight: bold; text-decoration: underline; margin-bottom: 10px;text-align:center;margin-top:10px;">Our quotation includes the following services:</h5>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                <strong style="color: #000;">AT ORIGIN:</strong> Layered packing, using quality white newsprint paper or non-stick paper, bubble/foam sheets, multi-ply corrugated rolls... (include all content as provided).
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                <strong style="color: #000;">SEA/AIR Freight:</strong> Custom clearance at origin and local handling charges, export documentation... (include all content as provided).
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                <strong style="color: #000;">AT DESTINATION:</strong> Clearance, direct delivery to the residence, immediate unpacking... (include all content as provided).
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                <strong style="color: #000;">Exclusions (If Applicable):</strong> Physical examination, x-ray, parking, demurrage... (include all content as provided).
                                            </p>
                                            <p style="font-size: 14px; line-height: 1.6; color: #333;">
                                                <strong style="color: #000;">INSURANCE:</strong> Transit Insurance is based on the replacement cost at the destination as declared.
                                            </p>
                                        </div>
                                    </body>
                                    </html>';
    ...
    public function send_quotation_mail(Request $request){
        try{
            ...
            if($followup_data->customer_email !== null && $followup_data->customer_email !== "" && !empty($followup_data->customer_email)){
                $customerEmail = $followup_data->customer_email;
            }elseif($followup_data->c_email !== null && $followup_data->c_email !== "" && !empty($followup_data->c_email)){
        ...
        $htmlAdmin .= '<!DOCTYPE html>
                ...
                foreach($to_mail as $to){
                    if (isset($to) && filter_var($to, FILTER_VALIDATE_EMAIL)) {
                        Mail::send([], [], function ($message) use ($html,$to, $subject, $pdf, $ccRecipients) {
                            $message->to($to);
                            $message->subject($subject);
                            $message->attachData($pdf->output(), "ERP-Quotation.pdf");
                            $message->html($html);
                        });
                    }
                }
                if (isset($admin) && filter_var($admin, FILTER_VALIDATE_EMAIL)) {
                    $admin = [$admin];
                    Mail::send([], [], function ($message) use ($htmlAdmin,$pdf, $admin, $cc_emails, $subject) {
                        $message->to($admin);
                        $message->subject($subject);
                        $message->attachData($pdf->output(), "ERP-Quotation.pdf");
                        // Add CC recipients
                        if (!empty($cc_emails)) {
                            foreach ($cc_emails as $ccRecipient) {
                                if (filter_var($ccRecipient, FILTER_VALIDATE_EMAIL)) { // Validate email format
    ...
    public function request_accepted($enquiry_id,$format_type){
        ...
        if($followup_data->agent_id !== null && $followup_data->agent_id !== ""){
            $customerName = $agents_data->company_name;
        }else if($followup_data->f_name !== null && $followup_data->f_name !== ""){
            $customerName = $followup_data->f_name;
        }
        ...
        if (isset($to_mail) && filter_var($to_mail, FILTER_VALIDATE_EMAIL)) {
            ...
            Mail::send([], [], function ($message) use ($bodyMessage,$toCustomer, $subject) {
                ...
                $message->subject($subject);
                $message->from('ventesh.hnrtechnologies@gmail.com', 'ERP');
                $message->html($bodyMessage);
            });
        }
        /* if (isset($admin) && filter_var($admin, FILTER_VALIDATE_EMAIL)) {
            $toAdmin = [$admin];
            Mail::send([], [], function ($message) use ($bodyMessage,$toAdmin, $subject) {
                $message->to($toAdmin);
                $message->subject($subject);
                $message->from('ventesh.hnrtechnologies@gmail.com', 'ERP');
                $message->html($bodyMessage);
